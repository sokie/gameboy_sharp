...
namespace CpuTestHarness
{
    ...
    /// model the SM83 single-step tests assume. Every write is recorded so the bus can be reset
    /// to zero between tests cheaply (only clearing the handful of addresses each test touched,
    /// rather than wiping all 64 KB 500,000+ times).
    /// </summary>
